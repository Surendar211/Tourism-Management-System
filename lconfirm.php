...
<h2 align="center">Do You Really Want to Logout</h2>
<input type="button" value="Yes" onclick=window.open("logout.php","_self")>
<input type="button" value="No" onclick=window.open("profile.php","_self")>
</fieldset>
 </form>
