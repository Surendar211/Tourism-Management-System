...
<h2 align="center">Do You Really Want to Delete This Package</h2>
<input type="button" value="Yes" onclick=window.open("pdelete.php?em=<?php echo $_REQUEST["em"] ; ?>","_self")>
<input type="button" value="No" onclick=window.open("mpack.php","_self")>
</fieldset>
 </form>
